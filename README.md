...
1. גלשו אל `https://orisamuel.github.io/42-content/admin/`
2. כתבו נושא ולחצו "✨ כתוב לי את הכתבה" - Gemini ימלא כותרת, כותרת משנה וגוף (דורש Gemini API Key, חד-פעמי, נשמר בדפדפן). אפשר כמובן גם לכתוב ידנית.
3. ערכו במידת הצורך, הוסיפו טופס לידים בקליק אם רוצים
4. הדביקו GitHub Token (חד-פעמי, נשמר בדפדפן) ולחצו "פרסום"
